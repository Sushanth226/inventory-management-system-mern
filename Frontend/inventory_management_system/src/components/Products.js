...
export default function Products() {
    ...
    const getProducts = async (e) => {
        ...
        try {
            const res = await fetch("https://inventory-management-system-mern-1.onrender.com/products", {
                method: "GET",
                headers: {
    ...
    const deleteProduct = async (id) => {
        ...
        const response = await fetch(`https://inventory-management-system-mern-1.onrender.com/deleteproduct/${id}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json"
            }
